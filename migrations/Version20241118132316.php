 ...
 */
final class Version20241118132316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT NOT NULL, ADD etat_id INT DEFAULT NULL, ADD campus_id INT DEFAULT NULL, ADD lieu_id INT DEFAULT NULL');
